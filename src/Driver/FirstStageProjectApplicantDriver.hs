...
list cli_id rec_id = do
  ...
  query
    connection
    "SELECT pw.project_applicant_id, pw.worker_id, pw.project_id, pw.estimated_end_date, wp.name, wp.birth_date \
    ...
    \ INNER JOIN worker_privates wp ON wp.worker_id = pw.worker_id \
