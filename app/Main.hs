...
listProjectWorker :: String -> IO ()
listProjectWorker clientId = do
  result <- runProjectWorkerGateway $ UseCase.ListProjectWorkers.exec (ClientId clientId)
  mapM_ print result
  print "========================"
...
main = do
  ...
  listProject
  listProjectWorker "cf71705d-de27-40fe-9181-e190e0a65eb6"
